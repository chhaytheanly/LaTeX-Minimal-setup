...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        % Placeholder for PoC Demo Image 2: Close-up of dense/overlapping fasteners
        % \fbox{\includegraphics[width=\linewidth]{figures/chapter4/poc_closeup_dense.png}}
        \caption{High-density fastener grouping}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        % Placeholder for PoC Demo Image 3: UI Dashboard showing final count
        % \fbox{\includegraphics[width=\linewidth]{figures/chapter4/poc_dashboard.png}}
